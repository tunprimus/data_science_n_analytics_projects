...
print(calc_augmented_dickey_fuller(df["pelvic"]))
print(calc_kwiatkowski_phillips_schmidt_shin(df["pelvic"]))

print(calc_augmented_dickey_fuller(df["echocardiography"]))
print(calc_kwiatkowski_phillips_schmidt_shin(df["echocardiography"]))
